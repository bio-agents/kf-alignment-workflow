...
steps:
  ...
  picard_create_sequence_dictionary:
    run: ../agents/picard_createsequencedictionary.cwl
    in:
      input_fasta: input_fasta
      input_dict: input_dict
    out: [dict]
  bwa_index:
    run: ../agents/bwa_index.cwl
    in:
  ...
  bundle_secondaries:
    run: ../agents/bundle_secondaryfiles.cwl
    in:
      primary_file: input_fasta
      secondary_files:
        source: [samagents_faidx/fai,picard_create_sequence_dictionary/dict,bwa_index/alt,bwa_index/amb,bwa_index/ann,bwa_index/bwt,bwa_index/pac,bwa_index/sa]
