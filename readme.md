...
- agent images: https://hub.docker.com/r/kfdrc/
- dockerfiles: https://github.com/d3b-center/bixagents
- tested with
  - rabix-v1.0.5: https://github.com/rabix/bunny/releases/tag/v1.0.5
  - cwlagent: https://github.com/common-workflow-language/cwlagent/releases/tag/1.0.20171107133715
...
simply select the files you wish to process. For command line interfaces such as cwlagent, your input
...
as seen below. When the string value is read in by a agent such as cwlagent it will interpret a `\\t` input
...
In command line interfaces such as cwlagent, your input should look like the following.
```json
{
  ...,
  "run_pe_reads_processing": false,
...
order. In command line interfaces such as cwlagent, your input should look like the following.
```json
{
  ...,
